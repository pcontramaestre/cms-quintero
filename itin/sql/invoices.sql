...
INSERT INTO `invoices` (`id`, `id_code`, `is_active`, `order_id`, `invoice_date`, `total_amount`, `tax_amount`, `subtotal`, `status`, `status_date`, `notes`, `ip_address`, `server_language`, `form_language`, `created_at`, `updated_at`) VALUES
